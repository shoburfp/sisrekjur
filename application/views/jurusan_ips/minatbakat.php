<div class="container">
    <div class="row mt-4">
        <h3 class="mx-auto">Minat Bakat IPS</h3>
    </div>
    ...
    <div class="row mt-3">
        <div class="col-md-8 mx-auto">
            <form action="<?= base_url('ControllerMinatBakatIps/proses'); ?>" method="post">
                ...
                <div class="row mt-2 mx-auto">
                    <div class="col-md-6 mx-auto">
                        ...
                        <a class="btn btn-secondary float-right" href="<?= base_url('ControllerMinatBakatIps/index'); ?>">Reset</a>
                    </div>
                </div>
            </form>